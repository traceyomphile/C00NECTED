...
SERVER_IP = socket.gethostbyname(socket.gethostname()) # Or use your specific IP like '196.47.192.177'
TCP_PORT = 50000
...
def start_client() -> None:
    ...
    while True:
        ...
        if command in ["SENDFILE", "SEND_FILE"]:
            ...
            # THE FIX: Extract the filename and send it with the GET_PEER request!
            filename = os.path.basename(filepath)
